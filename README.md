...
** The ESP8266_RPints_MQTT_AllInOne.ino has not been tested!! The ESP32_RPints_MQTT_AllInOne.ino is recommended for full integration.
...
FlowMonitor.py
~~~
Need to be placed into your RaspberryPints ...PathTo/html/python Folder
